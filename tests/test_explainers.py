...
class TestGuidePanel:
    ...
    def test_scenarios_describes_rent_invest_strategy(self) -> None:
        """Guide scenarios topic explains the rent + invest strategy."""
        assert "down payment" in _GUIDE_SCENARIOS_HTML.lower()
        assert "monthly difference" in _GUIDE_SCENARIOS_HTML.lower()
