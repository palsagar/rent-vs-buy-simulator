...
export const INPUT_DEFS = [
  ...
  { key: "closingCostBuyerPct", label: "Buyer closing costs", min: 0, max: 15, step: 0.001, fmt: (v) => fmtPct(v), section: "advanced", hint: "German buyer costs reach ~12% with Grunderwerbsteuer and Makler" },
  { key: "closingCostSellerPct", label: "Seller closing costs", min: 0, max: 10, step: 0.05, fmt: (v) => fmtPct(v), section: "advanced" },
  { key: "propertyTaxRate", label: "Property levy (% of value)", min: 0, max: 5, step: 0.0005, fmt: (v) => fmtPct(v, 2), section: "advanced" },
  { key: "annualHomeInsurance", label: "Home insurance /yr", min: 0, max: 5000, step: 10, fmt: fmtMoney, section: "advanced" },
  ...
  { key: "saleCgRatePct", label: "Home-sale CG rate", min: 0, max: 40, step: 0.1, fmt: (v) => fmtPct(v), section: "advanced" },
  { key: "portfolioCgRatePct", label: "Investment CG rate", min: 0, max: 40, step: 0.025, fmt: (v) => fmtPct(v), section: "advanced" },
  ...
  { key: "annualPropertyLevy", label: "Property levy /yr (flat)", min: 0, max: 10000, step: 1, fmt: fmtMoney, section: "advanced", hint: "Flat annual levy that does not scale with the home's value (UK council tax, DE Grundsteuer)." },
